...
namespace Nyanet
{
    public partial class Form1 : Form
    {
        ...
        ///                                                                                                                                          ///
        ///                                                                                                                                          ///
        ///                  N Y 4 R L K 0    28.03.2025 04:15                                                                                       ///
        ///                                                                                                                                          ///
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /*
        ⠋⠌⠁⠃⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠄⠠⠀⠄⠤⠐⡀⠄⠠⠀⢀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
        ...
        bool appPathGet = false, runnedOnce= false,runnedOnce2=false;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            #endregion
            string ttl_opt,snusnu= "-p -q -r -s -m -a"; //Magic key 5.12.2024
            ...
            if (comboBox1.SelectedIndex == 0)
                ...
                nyanetServiceFramework("-5" + ttl_opt, "start");
            else if (comboBox1.SelectedIndex == 9)
                nyanetServiceFramework("-6" + ttl_opt + " " + snusnu, "start");
            else if (comboBox1.SelectedIndex == 10)
                nyanetServiceFramework("-6" + ttl_opt, "start");
            else if (comboBox1.SelectedIndex == 11)
                nyanetServiceFramework("-7" + ttl_opt + " " + snusnu, "start");
            else nyanetServiceFramework("-7" + ttl_opt, "start");
        }
        ...
        private void runOnce()
        {
            ...
            comboBox1.Items.Add("-5 X Oto TTL, Ters Frag, Max Payload");
            comboBox1.Items.Add("-5 Oto TTL, Ters Frag, Max Payload");
            comboBox1.Items.Add("-6 X Yanlış Seq, Ters Frag, Max Payload");
            comboBox1.Items.Add("-6 Yanlış Seq, Ters Frag, Max Payload");
            comboBox1.Items.Add("-7 X Yanlış Chksum, Ters Frag, Max Payload");
        ...
        private void nyanetServiceFrameworkDelagate(string Options, string StartOrStop)
        {
            try
            {
                if (System.IO.File.Exists(Process.GetCurrentProcess().MainModule.FileName.Replace(Process.GetCurrentProcess().ProcessName + ".exe", "redirDNS"))&&StartOrStop != "stop")
                {
                    ...
                    if (System.IO.File.Exists(Process.GetCurrentProcess().MainModule.FileName.Replace(Process.GetCurrentProcess().ProcessName + ".exe", "debug.txt")))
                        writeLog($"Detected redirDNS file.\nUsing DNS Redirect dnsv4:{dnsv4} dnsv4_Port:{dnsv4_Port} dnsv6:{dnsv6} dnsv6_Port:{dnsv6_Port}");
                }
                #region Write a log
                if (System.IO.File.Exists("debug.txt")&&StartOrStop!="stop")
                {
        ...
        private void changeLangEnglish()
        {
            this.Invoke((MethodInvoker)delegate {
                ...
                comboBox1.Items.Add("-5 X Auto TTL, Reverse Frag, Max Payload");
                comboBox1.Items.Add("-5 Auto TTL, Reverse Frag, Max Payload");
                comboBox1.Items.Add("-6 X Wrong Seq, Reverse Frag, Max Payload");
                comboBox1.Items.Add("-6 Wrong Seq, Reverse Frag, Max Payload");
                comboBox1.Items.Add("-7 X Wrong Chksum, Reverse Frag, Max Payload");
