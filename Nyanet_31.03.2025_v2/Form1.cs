...
namespace Nyanet
{
    public partial class Form1 : Form
    {
        ...
        public Form1()//This method will auto run without called!
        {
            ...
            writeLog("Nyanet Kernel Logger has been Started!");
        ...
        private void runOnce()
        {
            ...
            if (notFound != "")
            {
                ...
                writeLog($"{notFound} Some of the files are missing!\nDownload it again from: https://github.com/ny4rlk0/Nyanet");
                writeLog("Shutting down Nyanet Kernel Logger...\nExiting!");
                Environment.Exit(0);
            }
