    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex == 0)
                ...
                nyanetServiceFramework(snusnu + ttl_opt, "start");//-l
            else if (comboBox1.SelectedIndex == 7)
                nyanetServiceFramework("-5" + ttl_opt +" "+ snusnu, "start");//-l
            else nyanetServiceFramework("-5" + ttl_opt, "start"); //Kod 5
        }
        ...
        private void runOnce()
        {
            ...
            comboBox1.Items.Add("Modeset 5 Sihirli");
            comboBox1.Items.Add("Modeset 5");
            this.Invoke((MethodInvoker)delegate
            {
        ...
        private void changeLangEnglish()
        {
            this.Invoke((MethodInvoker)delegate {
                ...
                comboBox1.Items.Add("Modeset 5 With Magic");
                comboBox1.Items.Add("Modeset 5");
                ...
                this.Invoke((MethodInvoker)delegate
                {
                    ...
                    {
                        try { comboBox1.SelectedIndex = comboBox1.FindString("-o Invalid Mode"); }
                        catch (Exception) { }
                    }
                });
            });
