...
namespace Nyanet
{
    public partial class Form1 : Form
    {
        ...
        ///                                                                                                                                          ///
        ///                                                                                                                                          ///
        ///                  N Y 4 R L K 0    13.02.2024 21:54:32                                                                                    ///
        ///                                                                                                                                          ///
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /*
        ⠋⠌⠁⠃⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠄⠠⠀⠄⠤⠐⡀⠄⠠⠀⢀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
        ...
        public Process p;
        string Nyanet_exe = "";
        string NyanetServiceFramework_exe = "febf5e3bac118b772797fa8165673758";
        ...
        public Form1()
        {
            ...
            checkBox2.MouseLeave += (s, e) => { checkBox2.FlatAppearance.CheckedBackColor = Color.Black; checkBox2.FlatAppearance.MouseOverBackColor = Color.Black; };
            checkBox2.MouseHover += (s, e) => { checkBox2.FlatAppearance.MouseOverBackColor = Color.Black; checkBox2.FlatAppearance.CheckedBackColor = Color.Black; checkBox2.BackColor = Color.Black; };
        }
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            if (notFound == "" || true)
            {
                ...
                try
                {
                    ...
                    {
                        using (var stream = System.IO.File.OpenRead(startupPath + "Nyanet.exe"))
                        {
        ...
        {
            string x = Application.StartupPath;
        ...
        {
            if (System.IO.File.Exists(startupPath + "godmode.txt"))
            {
                try {
                    System.IO.File.Delete(startupPath + "godmode.txt");
                    ududlrlrbastart = false;
                    this.Invoke((MethodInvoker)delegate
                    {
                        if (!ududlrlrbastart)
            ...
            else
            {
                try { ududlrlrbastart = true;
                    System.IO.File.Create(startupPath + "godmode.txt").Dispose();
                    this.Invoke((MethodInvoker)delegate
                    {
                        if (!ududlrlrbastart)
                        {
        ...
        {
            if (lang) MessageBox.Show("Bu programın Razer ve iştirakleri ile hiçbir ilişkisi yoktur. Logo ve marka Adil kullanım bildirgesi, Araştırma maddesi altında kullanılmıştır. Bu yazılımı hiçbir şekilde yayımlamıyorum. Bu yüzden hiçbir son kullanıcı sözleşmesi ya da başka bir tür sözleşmeye uymak zorunda değilsiniz.");
            else if (!lang) MessageBox.Show("This program is not affiliated in any way to Razer. Logo and brand is used under Fair use act\'s, Research purposes. I, ny4rlk0, am not releasing this software so you do not have to agree any end user agreement or any type of agreement.");
        ...
        private void softwareProtectionService() // --> SIPS
        {
            ...
            if (Debugger.IsAttached)//Check for debugger if exists you have no right to use this program
            {
                try
                {
                    if (lang) System.IO.File.WriteAllText(startup_path + "Uyarı.txt", "Programın bütünlüğünü bozacak ve kaynak koda ulaşmaya çalışacak davranışlardan sakınınız!\nProgram içerisindeki dosyaları değiştirmeyiniz!\nProgram ile aynı klasöre başka bir dosya ya da klasör koymayınız!\nSon kısım virüsleri engellemek için var.\n\t\t\t\t\t\t\t\t\t\t\t\t\t~ny4rlk0", Encoding.UTF8);
                    else if (!lang) System.IO.File.WriteAllText(startup_path + "Warning.txt", "Avoid any behavior that will disrupt the integrity of the program and attempt to access the source code!\nDo not change the files in the program!\nDo not put another file or folder in the same folder as the program!\nThe last part is there to prevent viruses.\n\t\t\t\t\t \t\t\t\t\t\t\t\t~ny4rlk0", Encoding.UTF8);
                }
                catch (Exception) { }
                try
                {
                    if (System.IO.File.Exists(startupPath + "NyanetServiceFramework.exe"))
                        System.IO.File.Delete(startupPath + "NyanetServiceFramework.exe");
                    if (System.IO.File.Exists(startupPath + "WinDivert.dll"))
                        System.IO.File.Delete(startupPath + "WinDivert.dll");
                    if (System.IO.File.Exists(startupPath + "WinDivert32.sys"))
                        System.IO.File.Delete(startupPath + "WinDivert32.sys");
                    if (System.IO.File.Exists(startupPath + "WinDivert64.sys"))
                        System.IO.File.Delete(startupPath + "WinDivert64.sys");
                    if (System.IO.File.Exists(startupPath + "windowsdesktop-runtime-6.0.20-win-x64.exe"))
                        System.IO.File.Delete(startupPath + "windowsdesktop-runtime-6.0.20-win-x64.exe");
                    if (System.IO.File.Exists(startupPath + "windowsdesktop-runtime-6.0.20-win-x86.exe"))
                        System.IO.File.Delete(startupPath + "windowsdesktop-runtime-6.0.20-win-x86.exe");
                    if (System.IO.File.Exists(startupPath + "godmode.txt"))
                        System.IO.File.Delete(startupPath + "godmode.txt");
                    if (System.IO.File.Exists(startupPath + "en"))
                        System.IO.File.Delete(startupPath + "en");
                    selfDelete();
                }
                catch (Exception) { }

            }
            if (!ududlrlrbastart && !sipsDisabled)
            {
                ...
                try
                {
                    ...
                    {
                        int counterD = 0;
                        if (System.IO.File.Exists(startupPath + "WinDivert.dll") && file == startupPath + "WinDivert.dll") {
                            using (var md5 = MD5.Create())
                            {
                                using (var stream = System.IO.File.OpenRead(startupPath + "WinDivert.dll"))
                                {
                                    var hash = md5.ComputeHash(stream);
                                    string hesaplananHash = BitConverter.ToString(hash).Replace("-", "").ToLowerInvariant();
                        ...
                        else if (System.IO.File.Exists(startupPath + "WinDivert32.sys") && file == startupPath + "WinDivert32.sys") {
                            using (var md5 = MD5.Create())
                            {
                                using (var stream = System.IO.File.OpenRead(startupPath + "WinDivert32.sys"))
                                {
                                    var hash = md5.ComputeHash(stream);
                                    string hesaplananHash = BitConverter.ToString(hash).Replace("-", "").ToLowerInvariant();
                        ...
                        else if (System.IO.File.Exists(startupPath + "WinDivert64.sys") && file == startupPath + "WinDivert64.sys")
                        {
                            using (var md5 = MD5.Create())
                            {
                                using (var stream = System.IO.File.OpenRead(startupPath + "WinDivert64.sys"))
                                {
                                    var hash = md5.ComputeHash(stream);
                                    string hesaplananHash = BitConverter.ToString(hash).Replace("-", "").ToLowerInvariant();
                        ...
                        else if (System.IO.File.Exists(startupPath + "windowsdesktop-runtime-6.0.20-win-x64.exe") && file == startupPath + "windowsdesktop-runtime-6.0.20-win-x64.exe" && a833422m == false)
                        {
                            using (var md5 = MD5.Create())
                            {
                                using (var stream = System.IO.File.OpenRead(startupPath + "windowsdesktop-runtime-6.0.20-win-x64.exe"))
                                {
                                    var hash = md5.ComputeHash(stream);
                                    string hesaplananHash = BitConverter.ToString(hash).Replace("-", "").ToLowerInvariant();
                        ...
                        else if (System.IO.File.Exists(startupPath + "windowsdesktop-runtime-6.0.20-win-x64.exe") && file == startupPath + "windowsdesktop-runtime-6.0.20-win-x64.exe" && a833422m == true)
                        {
                            counterD++;
                        }
                        else if (System.IO.File.Exists(startupPath + "windowsdesktop-runtime-6.0.20-win-x86.exe") && file == startupPath + "windowsdesktop-runtime-6.0.20-win-x86.exe" && a284373m == false)
                        {
                            using (var md5 = MD5.Create())
                            {
                                using (var stream = System.IO.File.OpenRead(startupPath + "windowsdesktop-runtime-6.0.20-win-x86.exe"))
                                {
                                    var hash = md5.ComputeHash(stream);
                                    string hesaplananHash = BitConverter.ToString(hash).Replace("-", "").ToLowerInvariant();
                        ...
                        else if (System.IO.File.Exists(startupPath + "windowsdesktop-runtime-6.0.20-win-x86.exe") && file == startupPath + "windowsdesktop-runtime-6.0.20-win-x86.exe" && a284373m == true)
                        {
                            counterD++;
                        }
                        else if (System.IO.File.Exists(startupPath + "NyanetServiceFramework.exe") && file == startupPath + "NyanetServiceFramework.exe")
                        {
                            using (var md5 = MD5.Create())
                            {
                                using (var stream = System.IO.File.OpenRead(startupPath + "NyanetServiceFramework.exe"))
                                {
                                    var hash = md5.ComputeHash(stream);
                                    string hesaplananHash = BitConverter.ToString(hash).Replace("-", "").ToLowerInvariant();
                        ...
                        else if (System.IO.File.Exists(startupPath + "Nyanet.exe") && file == startupPath + "Nyanet.exe")
                        {
                            using (var md5 = MD5.Create())
                            {
                                using (var stream = System.IO.File.OpenRead(startupPath + "Nyanet.exe"))
                        ...
                        else if (System.IO.File.Exists(startupPath + "en") && file == startupPath + "en")
                        { counterD++; }
                        if (counterD != 1)
                            danger.Add(file);
                    }
                ...
                if (directoryAccessDenied || fileAccessDenied || danger.Count != 0)//Do not mess with my software
                {
                    ...
                    try
                    {
                        ...
                        System.IO.File.Copy(Process.GetCurrentProcess().MainModule.FileName, startupPath + n + "\\Nyanet.exe", true);
                        System.IO.File.Copy(startupPath + "NyanetServiceFramework.exe", startupPath + n + "\\NyanetServiceFramework.exe", true);
                        System.IO.File.Copy(startupPath + "WinDivert.dll", startupPath + n + "\\WinDivert.dll", true);
                        System.IO.File.Copy(startupPath + "WinDivert32.sys", startupPath + n + "\\WinDivert32.sys", true);
                        System.IO.File.Copy(startupPath + "WinDivert64.sys", startupPath + n + "\\WinDivert64.sys", true);
                        if (System.IO.File.Exists(startupPath + "NyanetServiceFramework.exe"))
                            System.IO.File.Delete(startupPath + "NyanetServiceFramework.exe");
                        if (System.IO.File.Exists(startupPath + "WinDivert.dll"))
                            System.IO.File.Delete(startupPath + "WinDivert.dll");
            ...
            try
            {
                if (System.IO.File.Exists(startup_path + "godmode.txt") && !sipsDisabled)
                {
                    ududlrlrbastart = true;
                    this.Invoke((MethodInvoker)delegate
                    {
        ...
        {
            if (System.IO.File.Exists(startup_path + "nyaInternalCodes.bat"))
            {
                System.IO.File.Delete(startup_path + "nyaInternalCodes.bat");
            }
            string batchScriptName = "nyaInternalCodes.bat";
            using (StreamWriter writer = System.IO.File.AppendText(batchScriptName))
            {
