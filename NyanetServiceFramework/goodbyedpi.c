...
int main(int argc, char *argv[]) {
    ...
    ///
    while ((opt = getopt_long(argc, argv, "nyarlko", long_options, NULL)) != -1) {
        switch (opt) {
        case 'n':
        ...
        case 'y':
            ...
            puts("Started with mode y");
            break;
        case 'a':
            do_passivedpi = do_host = do_host_removespace \
                = do_fragment_https = 1;
            https_fragment_size = 40u;
            puts("Started with mode a");
            break;
        case 'r':
            do_passivedpi = do_host = do_host_removespace = 1;
            puts("Started with mode r");
            break;
        case 'l':
        ...
        case 'k':
            ...
            do_wrong_seq = 1;
            max_payload_size = 1200;
            puts("Started with mode k");
            break;
        case 'o':
            puts("Started with mode o");
            exit(0);
        default:
            do_fragment_http = do_fragment_https = 1;
            do_reverse_frag = do_native_frag = 1;
